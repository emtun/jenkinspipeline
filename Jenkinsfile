        ...
        stage ('Deployments'){
            parallel{
                ...
                stage ("Deploy to Production"){
                    steps {
                        bat "scp -i "C:\\Users\\Emre\\AmazonAWS\\tomcat-demo.pem" "C:\\Program Files (x86)\\Jenkins\\workspace\\FullyAutomated\\webapp\\target\\*.war" "ec2-user@${params.tomcat_prod}:/var/lib/tomcat7/webapps""
                    }
                }
            }
        }
